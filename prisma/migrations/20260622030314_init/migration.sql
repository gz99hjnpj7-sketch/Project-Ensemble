...
-- CreateIndex
CREATE UNIQUE INDEX "NormalizedMarket_sourcePlatform_sourceMarketId_key" ON "NormalizedMarket"("sourcePlatform", "sourceMarketId");
...
-- CreateIndex
CREATE INDEX "CompositeForecast_clusterId_computedAt_idx" ON "CompositeForecast"("clusterId", "computedAt");
